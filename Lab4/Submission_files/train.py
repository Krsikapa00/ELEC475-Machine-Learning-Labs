...
def train(n_epochs, optimizer, model, loss_fn, train_loader, scheduler, device,
    ...
    for epoch in range(starting_epoch, n_epochs + 1):
        ...
        if evaluate_epochs:
            ...
            top_1_acc, test_top_1_acc, train_confusion_matrix, test_confusion_matrix = evaluate_epoch_acc(model, train_loader, device, test_loader=test_loader)
            ...
            print("Confusion Matricies: (TP, TN, FP, FN)")
            print("Train Matrix: {}".format(train_confusion_matrix))
            print("Test Matrix: {}".format(test_confusion_matrix))
