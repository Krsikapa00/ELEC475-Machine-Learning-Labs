...
def plotLosses(total_losses, content_losses, style_losses):
    ...
    if args.p is not None:
        try:
            with open(args.p, 'rb') as file:
                ...
                print("Loaded saved losses from file successfully: \n{} \n{} \n{}".format(total_losses, content_losses,
                                                                                          style_losses))
                plotLosses(total_losses, content_losses, style_losses)

        except Exception as e:
            print(f"An error occurred while loading arrays: {str(e)}")
    else:
        plotLosses(total_loss, content_loss, style_loss)
